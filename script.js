...
const feelValueTxt = document.querySelector(".feel-value-txt");
...
const apiKey = "4916df95ccd02d1a403828b92c076e46";
...
async function updateWeatherInfo(city) {
  ...
  feelValueTxt.textContent = Math.round(feels_like) + " °C";
  humidityValueTxt.textContent = humidity + "%";
  windValueTxt.textContent = speed + " m/s";
  pressureValueTxt.textContent = pressure;
  currentDateTxt.textContent = getCurrentDate();
  weatherSummaryImg.src = `https://raw.githubusercontent.com/Opxm007/weather/main/${getWeatherIcon(
    id
  )}`;
